                ...
                return (
                    <form onSubmit={handleSubmit}>
                        ...
                        <label htmlFor="company"> EMPRESA <span> * </span> </label>
                            <input id="company" placeholder="Sua melhor empresa" value={company} onChange={event => setCompany(event.target.value)}/>
                        <label htmlFor="techs"> TECNOLOGIAS <span> * (separadas por vírgula) </span> </label>
                            <input id="techs" placeholder="Suas melhores tecnologias" value={techs} onChange={event => setTechs(event.target.value)}/>
                        <label htmlFor="price"> VALOR DA DIÁRIA <span> * (em branco para gratuita) </span> </label>
                            <input id="price" placeholder="Sua melhor diária" value={price} onChange={event => setPrice(event.target.value)}/>
